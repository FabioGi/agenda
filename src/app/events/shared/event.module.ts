...
import { EventsDayviewComponent, DialogUnavailable } from './../events-dayview/events-dayview.component';
...
@NgModule({
  ...
  entryComponents: [DialogNewEvent, DialogSeeEvent, DialogUnavailable]      
})
